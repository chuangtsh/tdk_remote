...
local_parameters = [{'name': 'camera_name1',        'default': 'cam_forward',          'description': 'camera1 unique name'},
                    ...
                    {'name': 'serial_no1',          'default': '_313522070126', 'description': 'camera1 serial number'},
                    {'name': 'serial_no2',          'default': '_336222073785', 'description': 'camera2 serial number'},
                    ...
                    {'name': 'enable_depth1',           'default': 'false', 'description': 'enable depth stream'},
                    {'name': 'enable_depth2',           'default': 'false', 'description': 'enable depth stream'},
                    {'name': 'pointcloud.enable1',      'default': 'false', 'description': 'enable pointcloud'},
                    {'name': 'pointcloud.enable2',      'default': 'false', 'description': 'enable pointcloud'},
                    ...
                    {'name': 'depth_module.enable_auto_exposure1', 'default': 'false', 'description': 'enable/disable auto exposure for depth image'},
                    {'name': 'depth_module.enable_auto_exposure2', 'default': 'false', 'description': 'enable/disable auto exposure for depth image'},
                    {'name': 'align_depth.enable1',           'default': 'false', 'description': 'enable align depth filter'},
                    {'name': 'align_depth.enable2',           'default': 'false', 'description': 'enable align depth filter'},
                    ]
